...
<link href='http://fonts.googleapis.com/css?family=Pathway+Gothic+One|Marvel|Coda|Cookie|Nixie+One|Rochester|Pompiere|Dosis|Roboto+Condensed|Roboto' rel='stylesheet' type='text/css'>
...
<li class="name">
<h1><a href="content"><img style="height:30px;margin-right:10px;margin-bottom:4px;"src="ressources/images/lr1.png" alt="Example" />REVECLAIR</a></h1>
</li>
